            ...
            <div class="item form-group">
                ...
                <div class="item form-group">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="leader" name="leader_info" value="{{ old('leader_info') == null ? $activity->leader.' - '.$activity->Leader->name.' - '.$activity->Leader->ClassOb->name : old('leader_info') }}">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="start_date" class="form-control single_cal4"
                            aria-describedby="inputSuccess2Status" value="{{ old('start_date') == null ? date('d/m/Y', strtotime($activity->start_date)) : old('start_date') }}">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="end_date" class="form-control single_cal4"
                            aria-describedby="inputSuccess2Status" value="{{ old('end_date') == null ? date('d/m/Y', strtotime($activity->end_date)) : old('end_date') }}">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="start_regis_date" class="form-control single_cal4"
                            aria-describedby="inputSuccess2Status" value="{{ old('start_regis_date') == null ? date('d/m/Y', strtotime($activity->start_regis_date)) : old('start_regis_date') }}">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="end_regis_date" class="form-control single_cal4"
                            aria-describedby="inputSuccess2Status" value="{{ old('end_regis_date') == null ? date('d/m/Y', strtotime($activity->end_regis_date)) : old('end_regis_date')  }}">
                        </div>
                    </div>
                    <div class="item form-group">
